...
namespace FileWriter.SkiaSharpWbmp
{
    /// <summary>
    ...
    public sealed class WbmpSkiaSharpExporter : IProjectExporter
    {
        ...
        public WbmpSkiaSharpExporter(ShapeRenderer renderer, ContainerPresenter presenter)
        {
            _renderer = renderer;
        ...
        void Save(string path, XContainer container)
        {
            ...
            using (var bitmap = new SKBitmap(info))
            {
                ...
                using (var data = image.Encode(SKImageEncodeFormat.Wbmp, 100))
