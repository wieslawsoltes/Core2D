    ...
    public class EditorDockFactory : DockFactory
    {
        ...
        public override void InitLayout(IView layout)
        {
            ContextLocator = new Dictionary<string, Func<object>>
            {
                ...
                [nameof(GroupsTool)] = () => _serviceProvider.GetService<IProjectEditor>()?.Project?.CurrentGroupLibrary,
                [nameof(DatabasesTool)] = () => _serviceProvider.GetService<IProjectEditor>(),
                [nameof(StylesTool)] = () => _serviceProvider.GetService<IProjectEditor>()?.Project?.CurrentStyleLibrary,
