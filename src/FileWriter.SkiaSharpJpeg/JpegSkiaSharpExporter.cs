...
namespace FileWriter.SkiaSharpJpeg
{
    /// <summary>
    ...
    public sealed class JpegSkiaSharpExporter : IProjectExporter
    {
        ...
        public JpegSkiaSharpExporter(ShapeRenderer renderer, ContainerPresenter presenter)
        {
            _renderer = renderer;
        ...
        void Save(string path, XContainer container)
        {
            ...
            using (var bitmap = new SKBitmap(info))
            {
                ...
                using (var data = image.Encode(SKImageEncodeFormat.Jpeg, 100))
