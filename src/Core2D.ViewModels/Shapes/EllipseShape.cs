...
namespace Core2D.Shapes
{
    ...
    public class EllipseShape : TextShape, IEllipseShape
    {
        ...
        public static IEllipseShape Create(double x1, double y1, double x2, double y2, IShapeStyle style, IBaseShape point, bool isStroked = true, bool isFilled = false, string text = null, string name = "")
        {
        ...
        /// <param name="name">The shape name.</param>
        /// <returns>The new instance of the <see cref="EllipseShape"/> class.</returns>
        public static IEllipseShape Create(double x, double y, IShapeStyle style, IBaseShape point, bool isStroked = true, bool isFilled = false, string text = null, string name = "")
        {
        ...
        /// <param name="name">The shape name.</param>
        /// <returns>The new instance of the <see cref="EllipseShape"/> class.</returns>
        public static IEllipseShape Create(IPointShape topLeft, IPointShape bottomRight, IShapeStyle style, IBaseShape point, bool isStroked = true, bool isFilled = false, string text = null, string name = "")
        {
            return new EllipseShape()
            {
                Name = name,
