...
/// <summary>Keeps coordinate subscriptions scoped to the realized editor and its current document.</summary>
public sealed class StudioCoordinateEditorBehavior : Behavior<StudioCoordinateEditor>
{
    ...
    {
        if (e.Property == StudioCoordinateEditor.SourceProperty || e.Property == StudioEditContext.HistoryProperty)
