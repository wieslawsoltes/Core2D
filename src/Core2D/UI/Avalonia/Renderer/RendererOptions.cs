...
namespace Core2D.UI.Avalonia.Renderer
{
    ...
    public class RendererOptions
    {
        ...
        /// </summary>
        public static readonly AttachedProperty<IDataFlow> DataFlowProperty =
            AvaloniaProperty.RegisterAttached<RendererOptions, AvaloniaObject, IDataFlow>("DataFlow", null, true, BindingMode.TwoWay);
