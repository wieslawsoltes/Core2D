...
namespace Core2D.Editor.Tools.Decorators
{
    ...
    public class BoxDecorator : ObservableObject, IDrawable, IDecorator
    {
        ...
        private List<IPointShape> _pointsRotate;
        ...
        private void MoveTop(double dy)
        {
            ...
            _pointsTop.Sort(PointUtil.CompareY);

            var scaleX = 1.0;
            var scaleY = (_groupBox.Bounds.Height - dy) / _groupBox.Bounds.Height;
            var centerX = _anchorTop.X;
            var centerY = _anchorTop.Y;
        ...
        private void MoveBottom(double dy)
        {
            ...
            _pointsBottom.Sort(PointUtil.CompareY);

            var scaleX = 1.0;
            var scaleY = (_groupBox.Bounds.Height + dy) / _groupBox.Bounds.Height;
            var centerX = _anchorBottom.X;
            var centerY = _anchorBottom.Y;
            var matrix = Matrix2.ScaleAt(scaleX, scaleY, centerX, centerY);
        ...
        private void MoveLeft(double dx)
        {
            ...
            _pointsLeft.Sort(PointUtil.CompareX);

            var scaleX = (_groupBox.Bounds.Width - dx) / _groupBox.Bounds.Width;
            var scaleY = 1.0;
            var centerX = _anchorLeft.X;
            var centerY = _anchorLeft.Y;
            var matrix = Matrix2.ScaleAt(scaleX, scaleY, centerX, centerY);
        ...
        private void MoveRight(double dx)
        {
            ...
            _pointsRight.Sort(PointUtil.CompareX);
