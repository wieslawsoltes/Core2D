...
namespace Core2D.Shapes
{
    ...
    public class RectangleShape : TextShape, ICopyable
    {
        ...
        public static RectangleShape Create(double x1, double y1, double x2, double y2, ShapeStyle style, BaseShape point, bool isStroked = true, bool isFilled = false, string text = null, string name = "")
        {
        ...
        /// <param name="name">The shape name.</param>
        /// <returns>The new instance of the <see cref="RectangleShape"/> class.</returns>
        public static RectangleShape Create(double x, double y, ShapeStyle style, BaseShape point, bool isStroked = true, bool isFilled = false, string text = null, string name = "")
        {
        ...
        /// <param name="name">The shape name.</param>
        /// <returns>The new instance of the <see cref="RectangleShape"/> class.</returns>
        public static RectangleShape Create(PointShape topLeft, PointShape bottomRight, ShapeStyle style, BaseShape point, bool isStroked = true, bool isFilled = false, string text = null, string name = "")
        {
            return new RectangleShape()
            {
                Name = name,
