...
namespace Core2D.Editor.Views
{
    ...
    /// Groups view.
    /// </summary>
    public class GroupsView : ViewBase<ProjectEditor>
    {
        ...
        /// <summary>
        /// Initialize new instance of <see cref="GroupsView"/> class.
        /// </summary>
        /// <param name="serviceProvider">The service provider.</param>
        public GroupsView(IServiceProvider serviceProvider) : base()
        {
