// Derived from AvaloniaUI/Avalonia 11.3.12 (MIT); see LICENSE.Avalonia.txt.
using System;
...
using Avalonia.Themes.Browser.Accents;

namespace Avalonia.Themes.Browser;

/// <summary>
/// Represents a specialized resource dictionary that contains color resources used by BrowserTheme elements.
/// </summary>
/// <remarks>
/// This class can only be used in <see cref="BrowserTheme.Palettes"/>.
/// </remarks>
