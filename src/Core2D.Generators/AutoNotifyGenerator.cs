...
namespace Core2D
{
    public enum AccessModifier
    {
		...
		public void Execute(GeneratorExecutionContext context)
		{
			...
			var attributeSymbol = compilation.GetTypeByMetadataName("Core2D.AutoNotifyAttribute");
			if (attributeSymbol is null)
			{
				return;
			}

			var notifySymbol = compilation.GetTypeByMetadataName("Core2D.ViewModelBase");
