...
namespace Core2D.Shapes
{
    ...
    public class CubicBezierShape : BaseShape, ICubicBezierShape
    {
        ...
        public static ICubicBezierShape Create(double x1, double y1, double x2, double y2, double x3, double y3, double x4, double y4, ShapeStyle style, IBaseShape point, bool isStroked = true, bool isFilled = false, string name = "")
        {
        ...
        /// <param name="name">The shape name.</param>
        /// <returns>The new instance of the <see cref="CubicBezierShape"/> class.</returns>
        public static ICubicBezierShape Create(double x, double y, ShapeStyle style, IBaseShape point, bool isStroked = true, bool isFilled = false, string name = "")
        {
        ...
        /// <param name="name">The shape name.</param>
        /// <returns>The new instance of the <see cref="CubicBezierShape"/> class.</returns>
        public static ICubicBezierShape Create(IPointShape point1, IPointShape point2, IPointShape point3, IPointShape point4, ShapeStyle style, IBaseShape point, bool isStroked = true, bool isFilled = false, string name = "")
        {
            return new CubicBezierShape()
            {
                Name = name,
