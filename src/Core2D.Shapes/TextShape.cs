...
namespace Core2D.Shapes
{
    ...
    public class TextShape : BaseShape, ITextShape
    {
        ...
        public static ITextShape Create(double x1, double y1, double x2, double y2, IShapeStyle style, IBaseShape point, string text, bool isStroked = true, string name = "")
        {
        ...
        /// <param name="name">The shape name.</param>
        /// <returns>The new instance of the <see cref="TextShape"/> class.</returns>
        public static ITextShape Create(double x, double y, IShapeStyle style, IBaseShape point, string text, bool isStroked = true, string name = "")
        {
        ...
        /// <param name="name">The shape name.</param>
        /// <returns>The new instance of the <see cref="TextShape"/> class.</returns>
        public static ITextShape Create(IPointShape topLeft, IPointShape bottomRight, IShapeStyle style, IBaseShape point, string text, bool isStroked = true, string name = "")
        {
            return new TextShape()
            {
                Name = name,
