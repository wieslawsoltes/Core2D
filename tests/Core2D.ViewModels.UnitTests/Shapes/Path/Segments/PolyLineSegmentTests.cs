...
namespace Core2D.UnitTests
{
    public class PolyLineSegmentTests
    {
        ...
        {
            var target = _factory.CreatePolyLineSegment(ImmutableArray.Create<IPointShape>(), true, true);
        ...
        {
            var segment = _factory.CreatePolyLineSegment(ImmutableArray.Create<IPointShape>(), true, true);
